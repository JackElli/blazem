...
type LayoutRouteId = RouteId | "/(main)/backup" | "/(main)/export" | "/(main)/folder/[id]" | "/(main)/folders" | "/(main)/help" | "/(main)/import" | "/(main)/nodes" | "/(main)/recents" | "/(main)/rules" | "/(main)/search" | "/(main)/stats"
